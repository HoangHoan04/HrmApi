...
namespace HrmApi.Application.Features.ContractType.Commands
{
    ...
    public class CreateContractTypeCommandHandler : IRequestHandler<CreateContractTypeCommand, Guid>
    {
        ...
        internal async Task ValidateAsync(ContractTypeCommandFields request, Guid? excludeId, CancellationToken cancellationToken)
        {
            ...
            bool exists = await _context.ContractTypeEntities
            ...
            {
                bool companyExists = await _context.CompanyEntities
    ...
    public class UpdateContractTypeCommandHandler : IRequestHandler<UpdateContractTypeCommand, bool>
    {
        private readonly IApplicationDbContext _context;
        private readonly IActionLogService _actionLog;
        private readonly CreateContractTypeCommandHandler _createHandler;

        public UpdateContractTypeCommandHandler(IApplicationDbContext context, IActionLogService actionLog)
        {
            _context = context;
            _actionLog = actionLog;
            _createHandler = new CreateContractTypeCommandHandler(context, actionLog);
        }

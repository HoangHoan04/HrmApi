...
namespace HrmApi.Application.Mappings
{
    internal class ShiftMasterMapper
    {
        ...
        public static void ApplyCommandFields(ShiftMasterEntity entity, ShiftMasterCommandFields fields)
        {
            ...
            if (fields.StartTime.HasValue)
            {
                entity.StartTime = fields.StartTime.Value;
            }

            if (fields.EndTime.HasValue)
            {
                entity.EndTime = fields.EndTime.Value;
            }

            entity.BreakStartTime = fields.BreakStartTime;
            entity.BreakEndTime = fields.BreakEndTime;
            if (fields.BreakMinutes.HasValue)
            {
                entity.BreakMinutes = fields.BreakMinutes.Value;
            }

            if (fields.WorkingMinutes.HasValue)
            {
                entity.WorkingMinutes = fields.WorkingMinutes.Value;
            }

            if (fields.IsOvernight.HasValue)
            {
                entity.IsOvernight = fields.IsOvernight.Value;
            }
        ...
        public static object ToLogObject(ShiftMasterEntity entity)
        {
            return new
            {
                entity.Id,
